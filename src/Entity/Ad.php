...
class Ad
{
     ...
     * @Assert\Length(min=10,max=255, minMessage="Le titre doit faire plus de 10 caractères.", maxMessage="Le titre ne peut pas excéder 255 caractères.")
     */
    private $title;
     ...
     * @Assert\Length(min=20, minMessage="Votre introduction doit compter au moins 20 caractères.")
     */
