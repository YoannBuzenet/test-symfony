 ...
 * @UniqueEntity(
 * fields={"email"},
 * message="Un autre utilisateur s'ets déjà inscrit avec cette adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     * This property is set to public but SHOUDL be in private with getters and setters
    */
